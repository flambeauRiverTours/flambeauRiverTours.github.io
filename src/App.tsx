...
export function App() {
  ...
  return (
    <div className="min-h-screen relative bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-teal-500 selection:text-white">
      {/* Background ambient pastoral sage lighting glows */}
      <div className="fixed top-0 left-1/4 w-96 h-96 bg-emerald-600/10 dark:bg-emerald-500/15 rounded-full blur-3xl pointer-events-none -translate-y-1/2"></div>
      <div className="fixed bottom-0 right-1/4 w-96 h-96 bg-teal-600/10 dark:bg-green-700/15 rounded-full blur-3xl pointer-events-none translate-y-1/2"></div>
