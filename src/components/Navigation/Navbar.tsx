      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-blue-600 dark:text-sky-400 font-medium">{activeTabObj?.label}</p>
          </div>
        </div>
          ...
          >
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all ${
                      isActive
                        ? 'bg-blue-500/10 dark:bg-sky-500/15 text-blue-600 dark:text-sky-400 font-semibold'
            ...
            <div className="mt-4 pt-3 border-t border-slate-200/50 dark:border-slate-800/50 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400">
                <a href={`mailto:${personalInfo.email}`} className="p-1.5 hover:text-blue-600"><Mail className="w-4 h-4" /></a>
                ...
                <a href={personalInfo.linkedinUrl} target="_blank" rel="noopener noreferrer" className="p-1.5 hover:text-blue-600"><LinkedinIcon className="w-4 h-4" /></a>
              </div>
            </div>
          </motion.div>
        )}
